...
:ERC20TokenizedVault: pass:normal[xref:token/ERC20.adoc#ERC20TokenizedVault[`ERC20TokenizedVault`]]
:xref-ERC20TokenizedVault: xref:token/ERC20.adoc#ERC20TokenizedVault
:ERC20TokenizedVault-constructor: pass:normal[xref:token/ERC20.adoc#ERC20TokenizedVault-constructor-contract-IERC20Metadata-[`ERC20TokenizedVault.constructor`]]
:xref-ERC20TokenizedVault-constructor-contract-IERC20Metadata-: xref:token/ERC20.adoc#ERC20TokenizedVault-constructor-contract-IERC20Metadata-
:ERC20TokenizedVault-asset: pass:normal[xref:token/ERC20.adoc#ERC20TokenizedVault-asset--[`ERC20TokenizedVault.asset`]]
:xref-ERC20TokenizedVault-asset--: xref:token/ERC20.adoc#ERC20TokenizedVault-asset--
:ERC20TokenizedVault-totalAssets: pass:normal[xref:token/ERC20.adoc#ERC20TokenizedVault-totalAssets--[`ERC20TokenizedVault.totalAssets`]]
:xref-ERC20TokenizedVault-totalAssets--: xref:token/ERC20.adoc#ERC20TokenizedVault-totalAssets--
:ERC20TokenizedVault-convertToShares: pass:normal[xref:token/ERC20.adoc#ERC20TokenizedVault-convertToShares-uint256-[`ERC20TokenizedVault.convertToShares`]]
:xref-ERC20TokenizedVault-convertToShares-uint256-: xref:token/ERC20.adoc#ERC20TokenizedVault-convertToShares-uint256-
:ERC20TokenizedVault-convertToAssets: pass:normal[xref:token/ERC20.adoc#ERC20TokenizedVault-convertToAssets-uint256-[`ERC20TokenizedVault.convertToAssets`]]
:xref-ERC20TokenizedVault-convertToAssets-uint256-: xref:token/ERC20.adoc#ERC20TokenizedVault-convertToAssets-uint256-
:ERC20TokenizedVault-maxDeposit: pass:normal[xref:token/ERC20.adoc#ERC20TokenizedVault-maxDeposit-address-[`ERC20TokenizedVault.maxDeposit`]]
:xref-ERC20TokenizedVault-maxDeposit-address-: xref:token/ERC20.adoc#ERC20TokenizedVault-maxDeposit-address-
:ERC20TokenizedVault-maxMint: pass:normal[xref:token/ERC20.adoc#ERC20TokenizedVault-maxMint-address-[`ERC20TokenizedVault.maxMint`]]
:xref-ERC20TokenizedVault-maxMint-address-: xref:token/ERC20.adoc#ERC20TokenizedVault-maxMint-address-
:ERC20TokenizedVault-maxWithdraw: pass:normal[xref:token/ERC20.adoc#ERC20TokenizedVault-maxWithdraw-address-[`ERC20TokenizedVault.maxWithdraw`]]
:xref-ERC20TokenizedVault-maxWithdraw-address-: xref:token/ERC20.adoc#ERC20TokenizedVault-maxWithdraw-address-
:ERC20TokenizedVault-maxRedeem: pass:normal[xref:token/ERC20.adoc#ERC20TokenizedVault-maxRedeem-address-[`ERC20TokenizedVault.maxRedeem`]]
:xref-ERC20TokenizedVault-maxRedeem-address-: xref:token/ERC20.adoc#ERC20TokenizedVault-maxRedeem-address-
:ERC20TokenizedVault-previewDeposit: pass:normal[xref:token/ERC20.adoc#ERC20TokenizedVault-previewDeposit-uint256-[`ERC20TokenizedVault.previewDeposit`]]
:xref-ERC20TokenizedVault-previewDeposit-uint256-: xref:token/ERC20.adoc#ERC20TokenizedVault-previewDeposit-uint256-
:ERC20TokenizedVault-previewMint: pass:normal[xref:token/ERC20.adoc#ERC20TokenizedVault-previewMint-uint256-[`ERC20TokenizedVault.previewMint`]]
:xref-ERC20TokenizedVault-previewMint-uint256-: xref:token/ERC20.adoc#ERC20TokenizedVault-previewMint-uint256-
:ERC20TokenizedVault-previewWithdraw: pass:normal[xref:token/ERC20.adoc#ERC20TokenizedVault-previewWithdraw-uint256-[`ERC20TokenizedVault.previewWithdraw`]]
:xref-ERC20TokenizedVault-previewWithdraw-uint256-: xref:token/ERC20.adoc#ERC20TokenizedVault-previewWithdraw-uint256-
:ERC20TokenizedVault-previewRedeem: pass:normal[xref:token/ERC20.adoc#ERC20TokenizedVault-previewRedeem-uint256-[`ERC20TokenizedVault.previewRedeem`]]
:xref-ERC20TokenizedVault-previewRedeem-uint256-: xref:token/ERC20.adoc#ERC20TokenizedVault-previewRedeem-uint256-
:ERC20TokenizedVault-deposit: pass:normal[xref:token/ERC20.adoc#ERC20TokenizedVault-deposit-uint256-address-[`ERC20TokenizedVault.deposit`]]
:xref-ERC20TokenizedVault-deposit-uint256-address-: xref:token/ERC20.adoc#ERC20TokenizedVault-deposit-uint256-address-
:ERC20TokenizedVault-mint: pass:normal[xref:token/ERC20.adoc#ERC20TokenizedVault-mint-uint256-address-[`ERC20TokenizedVault.mint`]]
:xref-ERC20TokenizedVault-mint-uint256-address-: xref:token/ERC20.adoc#ERC20TokenizedVault-mint-uint256-address-
:ERC20TokenizedVault-withdraw: pass:normal[xref:token/ERC20.adoc#ERC20TokenizedVault-withdraw-uint256-address-address-[`ERC20TokenizedVault.withdraw`]]
:xref-ERC20TokenizedVault-withdraw-uint256-address-address-: xref:token/ERC20.adoc#ERC20TokenizedVault-withdraw-uint256-address-address-
:ERC20TokenizedVault-redeem: pass:normal[xref:token/ERC20.adoc#ERC20TokenizedVault-redeem-uint256-address-address-[`ERC20TokenizedVault.redeem`]]
:xref-ERC20TokenizedVault-redeem-uint256-address-address-: xref:token/ERC20.adoc#ERC20TokenizedVault-redeem-uint256-address-address-
:ERC20TokenizedVault-_convertToShares: pass:normal[xref:token/ERC20.adoc#ERC20TokenizedVault-_convertToShares-uint256-enum-Math-Rounding-[`ERC20TokenizedVault._convertToShares`]]
:xref-ERC20TokenizedVault-_convertToShares-uint256-enum-Math-Rounding-: xref:token/ERC20.adoc#ERC20TokenizedVault-_convertToShares-uint256-enum-Math-Rounding-
:ERC20TokenizedVault-_convertToAssets: pass:normal[xref:token/ERC20.adoc#ERC20TokenizedVault-_convertToAssets-uint256-enum-Math-Rounding-[`ERC20TokenizedVault._convertToAssets`]]
:xref-ERC20TokenizedVault-_convertToAssets-uint256-enum-Math-Rounding-: xref:token/ERC20.adoc#ERC20TokenizedVault-_convertToAssets-uint256-enum-Math-Rounding-
...
:ERC20TokenizedVault: pass:normal[xref:#ERC20TokenizedVault[`++ERC20TokenizedVault++`]]
:constructor: pass:normal[xref:#ERC20TokenizedVault-constructor-contract-IERC20Metadata-[`++constructor++`]]
:asset: pass:normal[xref:#ERC20TokenizedVault-asset--[`++asset++`]]
:totalAssets: pass:normal[xref:#ERC20TokenizedVault-totalAssets--[`++totalAssets++`]]
:convertToShares: pass:normal[xref:#ERC20TokenizedVault-convertToShares-uint256-[`++convertToShares++`]]
:convertToAssets: pass:normal[xref:#ERC20TokenizedVault-convertToAssets-uint256-[`++convertToAssets++`]]
:maxDeposit: pass:normal[xref:#ERC20TokenizedVault-maxDeposit-address-[`++maxDeposit++`]]
:maxMint: pass:normal[xref:#ERC20TokenizedVault-maxMint-address-[`++maxMint++`]]
:maxWithdraw: pass:normal[xref:#ERC20TokenizedVault-maxWithdraw-address-[`++maxWithdraw++`]]
:maxRedeem: pass:normal[xref:#ERC20TokenizedVault-maxRedeem-address-[`++maxRedeem++`]]
:previewDeposit: pass:normal[xref:#ERC20TokenizedVault-previewDeposit-uint256-[`++previewDeposit++`]]
:previewMint: pass:normal[xref:#ERC20TokenizedVault-previewMint-uint256-[`++previewMint++`]]
:previewWithdraw: pass:normal[xref:#ERC20TokenizedVault-previewWithdraw-uint256-[`++previewWithdraw++`]]
:previewRedeem: pass:normal[xref:#ERC20TokenizedVault-previewRedeem-uint256-[`++previewRedeem++`]]
:deposit: pass:normal[xref:#ERC20TokenizedVault-deposit-uint256-address-[`++deposit++`]]
:mint: pass:normal[xref:#ERC20TokenizedVault-mint-uint256-address-[`++mint++`]]
:withdraw: pass:normal[xref:#ERC20TokenizedVault-withdraw-uint256-address-address-[`++withdraw++`]]
:redeem: pass:normal[xref:#ERC20TokenizedVault-redeem-uint256-address-address-[`++redeem++`]]
:_convertToShares: pass:normal[xref:#ERC20TokenizedVault-_convertToShares-uint256-enum-Math-Rounding-[`++_convertToShares++`]]
:_convertToAssets: pass:normal[xref:#ERC20TokenizedVault-_convertToAssets-uint256-enum-Math-Rounding-[`++_convertToAssets++`]]

[.contract]
[[ERC20TokenizedVault]]
=== `++ERC20TokenizedVault++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.6.0/contracts/token/ERC20/extensions/ERC20TokenizedVault.sol[{github-icon},role=heading-link]
...
.Functions
--
* {xref-ERC20TokenizedVault-constructor-contract-IERC20Metadata-}[`++constructor(asset_)++`]
* {xref-ERC20TokenizedVault-asset--}[`++asset()++`]
* {xref-ERC20TokenizedVault-totalAssets--}[`++totalAssets()++`]
* {xref-ERC20TokenizedVault-convertToShares-uint256-}[`++convertToShares(assets)++`]
* {xref-ERC20TokenizedVault-convertToAssets-uint256-}[`++convertToAssets(shares)++`]
* {xref-ERC20TokenizedVault-maxDeposit-address-}[`++maxDeposit(_)++`]
* {xref-ERC20TokenizedVault-maxMint-address-}[`++maxMint(_)++`]
* {xref-ERC20TokenizedVault-maxWithdraw-address-}[`++maxWithdraw(owner)++`]
* {xref-ERC20TokenizedVault-maxRedeem-address-}[`++maxRedeem(owner)++`]
* {xref-ERC20TokenizedVault-previewDeposit-uint256-}[`++previewDeposit(assets)++`]
* {xref-ERC20TokenizedVault-previewMint-uint256-}[`++previewMint(shares)++`]
* {xref-ERC20TokenizedVault-previewWithdraw-uint256-}[`++previewWithdraw(assets)++`]
* {xref-ERC20TokenizedVault-previewRedeem-uint256-}[`++previewRedeem(shares)++`]
* {xref-ERC20TokenizedVault-deposit-uint256-address-}[`++deposit(assets, receiver)++`]
* {xref-ERC20TokenizedVault-mint-uint256-address-}[`++mint(shares, receiver)++`]
* {xref-ERC20TokenizedVault-withdraw-uint256-address-address-}[`++withdraw(assets, receiver, owner)++`]
* {xref-ERC20TokenizedVault-redeem-uint256-address-address-}[`++redeem(shares, receiver, owner)++`]
* {xref-ERC20TokenizedVault-_convertToShares-uint256-enum-Math-Rounding-}[`++_convertToShares(assets, rounding)++`]
* {xref-ERC20TokenizedVault-_convertToAssets-uint256-enum-Math-Rounding-}[`++_convertToAssets(shares, rounding)++`]
...
[.contract-item]
[[ERC20TokenizedVault-constructor-contract-IERC20Metadata-]]
...
[.contract-item]
[[ERC20TokenizedVault-_convertToAssets-uint256-enum-Math-Rounding-]]
